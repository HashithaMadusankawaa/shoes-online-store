...
<body>
  ...
  <div class="container-fluid ">
    <div class="row">
      ...
      <?php
        $package_rs = Database::search("SELECT COUNT(`id`) AS count FROM `product` WHERE `category_cat_id`='1' AND `status_status_id`='1'");
        ...
        ?>
        <h5 class="gm  text-black fs-4  text-start mt-5 ">Men's Sneakers & Shoes (<?php echo $package_count ?>)</h5>
      </div>
      <div class="sm col-4 col-lg-2 offset-lg-4 offset-2 text-end ">
        <select
          ...
          aria-label="Small select example" id="sortby" onchange="filter1()">
  ...
  <div class="container-fluid row">
    ...
    <div class="col-12 col-lg-10 p-1">
      ...
      $category_rs = Database::search("SELECT*FROM `category` WHERE `cat_id`= '1'");
      ...
      for ($x = 0; $x < $category_num; $x++) {
        ...
        <div class="container-fluid col-12  ">
          <div class="row g-2" id="product-list1">
