...
Database::iud("INSERT INTO `product_color`(`product_id`,`color`) VALUES ('".$product_id."','".$color1."');");
Database::iud("INSERT INTO `product_color`(`product_id`,`color`) VALUES ('".$product_id."','".$color2."');");
Database::iud("INSERT INTO `product_color`(`product_id`,`color`) VALUES ('".$product_id."','".$color3."');");
Database::iud("INSERT INTO `product_color`(`product_id`,`color`) VALUES ('".$product_id."','".$color4."');");

// Insert sizes and stock quantities into database
...
if($length <= 3 && $length > 0){
    ...
    for($x = 0;$x < $length;$x++){
        if(isset($_FILES["image".$x])){
            ...
            $file_name = "resoerce/shoe/".$title."_".$x."_".uniqid().$new_img_extension;
